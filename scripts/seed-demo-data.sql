...
('m2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222',
...
('m3333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333',
...
('m4444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444',
...
('m5555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555',
...
('e6666666-6666-6666-6666-666666666666', '66666666-6666-6666-6666-666666666666',
...
('e7777777-7777-7777-7777-777777777777', '77777777-7777-7777-7777-777777777777',
...
('e8888888-8888-8888-8888-888888888888', '88888888-8888-8888-8888-888888888888',
...
('eaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
...
('ebbbbbb0-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
...
('ecccccc0-cccc-cccc-cccc-cccccccccccc', 'cccccccc-cccc-cccc-cccc-cccccccccccc',
...
('edddddd0-dddd-dddd-dddd-dddddddddddd', 'dddddddd-dddd-dddd-dddd-dddddddddddd',
...
('s1111111-1111-1111-1111-111111111111', 'e6666666-6666-6666-6666-666666666666', 'm1111111-1111-1111-1111-111111111111',
 'active',
...
('s2222222-2222-2222-2222-222222222222', 'e7777777-7777-7777-7777-777777777777', 'm2222222-2222-2222-2222-222222222222',
 'active',
...
('s3333333-3333-3333-3333-333333333333', 'e9999999-9999-9999-9999-999999999999', 'm2222222-2222-2222-2222-222222222222',
 'mentee_completed',
...
UPDATE sessions SET mentee_completed_at = NOW() - INTERVAL '3 days' WHERE id = 's3333333-3333-3333-3333-333333333333';

-- ============ NOTIFICATIONS ============
INSERT INTO notifications (id, recipient_user_id, type, message, action_url, is_read) VALUES
('n1111111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 'session_accepted', 'Sarah Chen accepted your mentoring request!', '/sessions/s1111111-1111-1111-1111-111111111111', true),
('n2222222-2222-2222-2222-222222222222', '77777777-7777-7777-7777-777777777777', 'session_accepted', 'James Nguyen accepted your mentoring request!', '/sessions/s2222222-2222-2222-2222-222222222222', true),
('n3333333-3333-3333-3333-333333333333', '99999999-9999-9999-9999-999999999999', 'plan_generated', 'Your session plan is ready: SageMaker Deployment Deep Dive', '/sessions/s3333333-3333-3333-3333-333333333333/plan', true),
('n4444444-4444-4444-4444-444444444444', '66666666-6666-6666-6666-666666666666', 'opportunity_posted', 'New opportunity: Cloud Engineer at Canva', '/opportunities', false),
('n5555555-5555-5555-5555-555555555555', '77777777-7777-7777-7777-777777777777', 'meetup_reminder', 'Upcoming meetup: AWS Melbourne Monthly - Tomorrow at 6pm', '/meetups', false)
ON CONFLICT (id) DO NOTHING;
...
('o1111111-1111-1111-1111-111111111111', 'm4444444-4444-4444-4444-444444444444',
...
('o2222222-2222-2222-2222-222222222222', 'm3333333-3333-3333-3333-333333333333',
...
('mt111111-1111-1111-1111-111111111111', 'Melbourne', 'AWS Melbourne Monthly - Serverless Edition',
