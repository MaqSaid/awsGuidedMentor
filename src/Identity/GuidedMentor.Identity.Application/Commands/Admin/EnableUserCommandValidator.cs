...
/// <summary>
/// Validates EnableUserCommand: adminId required, targetUserId required, reason 10-500 chars.
/// </summary>
public sealed class EnableUserCommandValidator : AbstractValidator<EnableUserCommand>
{
    public EnableUserCommandValidator()
    {
        ...
        RuleFor(x => x.Reason)
            .NotEmpty().WithMessage("A reason is required for enabling a user account.")
